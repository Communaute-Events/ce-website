    ...
    <div className="flex flex-col min-h-screen bg-[#1D1D1F] dark:bg-gray-900">
      ...
      <main className="flex-1">
          ...
          <div className="container px-4 md:px-6">
            <div className="flex flex-col items-center space-y-4 text-center">
              ...
              <div className="space-y-2">
                ...
                Nous sommes un groupe de passionnés de Minecraft créant des outils pour la communauté française des événements Minecraft. Notre équipe est composée de développeurs passionnés et de joueurs Minecraft.
                </p>
        ...
        <section className="w-full bg-[#1D1D1F] dark:bg-gray-900 py-8 md:py-16 lg:py-24 xl:py-32" id="team">
          <div className="container px-4 md:px-6">
            <h2 className="text-2xl font-bold mb-8 text-gray-200 dark:text-gray-200">Our Team</h2>
